...
\abstract*{Fuzzy Cognitive Maps are very useful tools primarily in decision 
...
by experts often the temptation is too great to include many 
components, because they are not sure in their importance. An oversized 
...
loss. This effect does not cause a problem in practice if the model 
